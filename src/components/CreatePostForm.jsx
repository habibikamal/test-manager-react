...
export default function CreatePostForm() {
    ...
    const formSubmitHandler = async (event) => {
        ...
        try{
                let response = await fetch("https://6928d6bb9d311cddf3477443.mockapi.io/posts", {
                method: "POST",
                headers: {
    ...
    return (
        <>
{/* هر وقت شو میسیج برابر با یک بود نمایش داده شود */}
        {showMessage &&  <Alert message="post Message Successfuly craated" closeHandler={()=>setShowMessage(false)}/>}
                ...
                <div className="grid max-w-2xl grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                    <div className="sm:col-span-4">
                        ...
                        <div className="mt-2">
                            ...
                            focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" {...titleInputProps} />
                        </div>
                    </div>
                    ...
                    <div className="sm:col-span-4">
                        ...
                        <div className="mt-2">
                            <input id="category" name="category" type="text" className="block w-full rounded-md border-0 py-1.5 px-3 
                            text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 
                            focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" {...categoryInputProps} />
                        </div>
                    </div>
                    ...
                    <div className="col-span-full">
                        ...
                        <div className="mt-2">
                            <textarea
                                ...
                                name="body"
                                rows={3}
                                className="px-3 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 
